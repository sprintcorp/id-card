...
<!-- Mirrored from designreset.com/cork/ltr/demo6/auth_login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Sep 2020 07:08:29 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no">
    <title>Adeyemi Demonstration Model Nursery and Primary School Akure ID Card Portal</title>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class=""> <a href="/"><span class="brand-name">ID CARD PORTAL</span></a></h1>
                        ...
                        @csrf
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input name="email" value="{{ old('email') }}" required autocomplete="email" autofocus type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Username">
                                    @error('email')
